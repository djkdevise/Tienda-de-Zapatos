/*Actividad 3 – Evidencia 3 Incorporar estatutos IF anidado y SWITCH 
 *Desarrollo de aplicación en C++ Parte III.
 */
...
if (precio_Costo_Calzado <= 30000)
{
	tipo = 'A';
	porcentaje_utilidad = 0.50;
}else if(precio_Costo_Calzado >= 30000 && precio_Costo_Calzado <= 60000)
{
	tipo = 'B';
	porcentaje_utilidad = 0.40;
}else if(precio_Costo_Calzado >60000)
{
	tipo = 'C';
	porcentaje_utilidad = 0.30;
}

precio_Venta_Calzado = precio_Costo_Calzado + (precio_Costo_Calzado * porcentaje_utilidad);	
